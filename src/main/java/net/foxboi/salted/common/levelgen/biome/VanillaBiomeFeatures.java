...
public record VanillaBiomeFeatures() {
    ...
    public static void commonSpawns(BiomeEditor builder, int skeletonWeight) {
        caveSpawns(builder);
        monsters(builder, 95, 5, 0, skeletonWeight, false);
    }

    public static void commonSpawnWithZombieHorse(BiomeEditor builder) {
        caveSpawns(builder);
        monsters(builder, 90, 5, 5, 100, false);
    }

    public static void swampSpawns(BiomeEditor builder, int skeletonWeight) {
        commonSpawns(builder, skeletonWeight);
    ...
    public static void oceanSpawns(BiomeEditor builder, int squidWeight, int maxSquids, int codWeight) {
        builder.addSpawn(MobCategory.WATER_CREATURE, squidWeight, new MobSpawnSettings.SpawnerData(EntityType.SQUID, 1, maxSquids));
        builder.addSpawn(MobCategory.WATER_AMBIENT, codWeight, new MobSpawnSettings.SpawnerData(EntityType.COD, 3, 6));
        commonSpawns(builder);
        builder.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 1, 1));
    }

    public static void warmOceanSpawns(BiomeEditor builder, int squidWeight, int minSquids) {
        builder.addSpawn(MobCategory.WATER_CREATURE, squidWeight, new MobSpawnSettings.SpawnerData(EntityType.SQUID, minSquids, 4));
    ...
    public static void snowySpawns(BiomeEditor builder, boolean plains) {
        ...
        caveSpawns(builder);
        monsters(builder, plains ? 90 : 95, 5, plains ? 5 : 0, 20, false);
    ...
    public static void monsters(BiomeEditor builder, int zombieWeight, int villagerZombieWeight, int zombieHorseWeight, int skeletonWeight, boolean drownZombies) {
        builder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SPIDER, 4, 4));

        builder.addSpawn(MobCategory.MONSTER, zombieWeight, new MobSpawnSettings.SpawnerData(drownZombies ? EntityType.DROWNED : EntityType.ZOMBIE, 4, 4));
