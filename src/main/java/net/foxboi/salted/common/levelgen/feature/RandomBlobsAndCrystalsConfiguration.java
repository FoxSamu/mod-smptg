...
public record RandomBlobsAndCrystalsConfiguration(
    ...
    public static final Codec<RandomBlobsAndCrystalsConfiguration> CODEC = RecordCodecBuilder.create(inst -> inst.group(
    ...
    ).apply(inst, RandomBlobsAndCrystalsConfiguration::new));
    ...
    public static class Builder {
        ...
        public RandomBlobsAndCrystalsConfiguration build() {
            return new RandomBlobsAndCrystalsConfiguration(
                    iterations,
                    xzSpread,
                    ySpread,
                    blobPredicate,
