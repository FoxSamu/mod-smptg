...
public class BiomeBuilder implements BiomeEditor {
    ...
    private OptionalInt dryFoliageColor;
    private BiomeSpecialEffects.GrassColorModifier grassColorModifier;
    private float backgroundMusicVolume;
    private Optional<WeightedList<Music>> music;
    ...
    private Optional<AmbientParticleSettings> particles;
    ...
    @Override
    public BiomeEditor music(Optional<WeightedList<Music>> music) {
        this.music = music;
        return this;
    }

    @Override
    public BiomeEditor loopSound(Optional<Holder<SoundEvent>> sound) {
        this.loopSound = sound;
        return this;
    }

    @Override
    public BiomeEditor additionsSound(Optional<AmbientAdditionsSettings> sound) {
        this.additionsSound = sound;
        return this;
    }

    @Override
    public BiomeEditor moodSound(Optional<AmbientMoodSettings> sound) {
